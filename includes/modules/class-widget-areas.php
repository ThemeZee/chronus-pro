...
class Chronus_Pro_Widget_Areas {
	...
	static function setup() {
		...
		add_action( 'chronus_before_footer', array( __CLASS__, 'display_before_footer_columns' ), 5 );
		add_action( 'chronus_before_footer', array( __CLASS__, 'display_before_footer_copyright' ), 20 );
	}
