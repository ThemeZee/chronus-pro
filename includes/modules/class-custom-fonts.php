 ...
 * Custom Fonts Class
 */
class Chronus_Pro_Custom_Fonts {
	...
	static function setup() {
		...
		require_once CHRONUS_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-control.php';

		// Add Custom Fonts CSS code to custom stylesheet output.
		add_filter( 'chronus_pro_custom_css_stylesheet', array( __CLASS__, 'get_custom_fonts_css' ) );

		// Load Custom Fonts with the built-in theme functions.
		add_filter( 'chronus_get_fonts_url', array( __CLASS__, 'get_custom_fonts_url' ) );
	...
	static function font_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'chronus_pro_section_typography', array(
			'title'    => __( 'Typography', 'chronus-pro' ),
			'priority' => 80,
		...
		$wp_customize->add_setting( 'chronus_theme_options[text_font]', array(
		...
		$wp_customize->add_control( new Chronus_Pro_Customize_Font_Control(
			$wp_customize, 'text_font', array(
				'label'    => esc_html__( 'Body Font', 'chronus-pro' ),
				'section'  => 'chronus_pro_section_typography',
				'settings' => 'chronus_theme_options[text_font]',
				'priority' => 10,
			)
		) );

		// Add Title Font setting.
		$wp_customize->add_setting( 'chronus_theme_options[title_font]', array(
		...
		$wp_customize->add_control( new Chronus_Pro_Customize_Font_Control(
			$wp_customize, 'title_font', array(
				'label'    => esc_html_x( 'Headings', 'Font Setting', 'chronus-pro' ),
				'section'  => 'chronus_pro_section_typography',
				'settings' => 'chronus_theme_options[title_font]',
				'priority' => 20,
			)
		) );

		// Add Title Font Weight setting.
		$wp_customize->add_setting( 'chronus_theme_options[title_is_bold]', array(
		...
		$wp_customize->add_control( 'chronus_theme_options[title_is_bold]', array(
			'label'    => esc_html_x( 'Bold', 'Font Setting', 'chronus-pro' ),
			'section'  => 'chronus_pro_section_typography',
			'settings' => 'chronus_theme_options[title_is_bold]',
			'type'     => 'checkbox',
			'priority' => 30,
		) );

		// Add Title Uppercase setting.
		$wp_customize->add_setting( 'chronus_theme_options[title_is_uppercase]', array(
		...
		$wp_customize->add_control( 'chronus_theme_options[title_is_uppercase]', array(
			'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'chronus-pro' ),
			'section'  => 'chronus_pro_section_typography',
			'settings' => 'chronus_theme_options[title_is_uppercase]',
			'type'     => 'checkbox',
			'priority' => 40,
		) );

		// Add Navigation Font setting.
		$wp_customize->add_setting( 'chronus_theme_options[navi_font]', array(
		...
		$wp_customize->add_control( new Chronus_Pro_Customize_Font_Control(
			$wp_customize, 'navi_font', array(
				'label'    => esc_html_x( 'Navigation', 'Font Setting', 'chronus-pro' ),
				'section'  => 'chronus_pro_section_typography',
				'settings' => 'chronus_theme_options[navi_font]',
				'priority' => 50,
			)
		) );

		// Add Navi Font Weight setting.
		$wp_customize->add_setting( 'chronus_theme_options[navi_is_bold]', array(
		...
		$wp_customize->add_control( 'chronus_theme_options[navi_is_bold]', array(
			'label'    => esc_html_x( 'Bold', 'Font Setting', 'chronus-pro' ),
			'section'  => 'chronus_pro_section_typography',
			'settings' => 'chronus_theme_options[navi_is_bold]',
			'type'     => 'checkbox',
			'priority' => 60,
		) );

		// Add Navi Uppercase setting.
		$wp_customize->add_setting( 'chronus_theme_options[navi_is_uppercase]', array(
		...
		$wp_customize->add_control( 'chronus_theme_options[navi_is_uppercase]', array(
			'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'chronus-pro' ),
			'section'  => 'chronus_pro_section_typography',
			'settings' => 'chronus_theme_options[navi_is_uppercase]',
			'type'     => 'checkbox',
			'priority' => 70,
		) );

		// Add Widget Title Font setting.
		$wp_customize->add_setting( 'chronus_theme_options[widget_title_font]', array(
		...
		$wp_customize->add_control( new Chronus_Pro_Customize_Font_Control(
			$wp_customize, 'widget_title_font', array(
				'label'    => esc_html_x( 'Widget Titles', 'Font Setting', 'chronus-pro' ),
				'section'  => 'chronus_pro_section_typography',
				'settings' => 'chronus_theme_options[widget_title_font]',
				'priority' => 80,
			)
		) );

		// Add Widget Title Font Weight setting.
		$wp_customize->add_setting( 'chronus_theme_options[widget_title_is_bold]', array(
		...
		$wp_customize->add_control( 'chronus_theme_options[widget_title_is_bold]', array(
			'label'    => esc_html_x( 'Bold', 'Font Setting', 'chronus-pro' ),
			'section'  => 'chronus_pro_section_typography',
			'settings' => 'chronus_theme_options[widget_title_is_bold]',
			'type'     => 'checkbox',
			'priority' => 90,
		) );

		// Add Widget Title Uppercase setting.
		$wp_customize->add_setting( 'chronus_theme_options[widget_title_is_uppercase]', array(
		...
		$wp_customize->add_control( 'chronus_theme_options[widget_title_is_uppercase]', array(
			'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'chronus-pro' ),
			'section'  => 'chronus_pro_section_typography',
			'settings' => 'chronus_theme_options[widget_title_is_uppercase]',
			'type'     => 'checkbox',
			'priority' => 100,
		) );
	}
...
// Run Class.
add_action( 'init', array( 'Chronus_Pro_Custom_Fonts', 'setup' ) );
