...
( function( $ ) {
	...
	wp.customize( 'chronus_theme_options[primary_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'chronus_theme_options[secondary_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'chronus_theme_options[tertiary_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Accent Color Option */
	wp.customize( 'chronus_theme_options[accent_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'chronus_theme_options[highlight_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'chronus_theme_options[light_gray_color]', function( value ) {
		value.bind( function( newval ) {
	...
	/* Gray Color Option */
	wp.customize( 'chronus_theme_options[gray_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'chronus_theme_options[dark_gray_color]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'chronus_theme_options[page_bg_color]', function( value ) {
		value.bind( function( newval ) {
			...
			if( isColorDark( newval ) ) {
				text_color = '#fff';
				medium_text_color = 'rgba(255,255,255,0.8)';
				light_text_color = 'rgba(255,255,255,0.6)';
				...
				medium_border_color = 'rgba(0, 0, 0, 0.15)';
				light_border_color = 'rgba(0, 0, 0, 0.075)';
			}
