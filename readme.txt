=== Chronus Pro ===
Plugin URL: https://themezee.com/addons/chronus-pro/
...
Adds additional features and customization options to the Chronus theme.

== Description ==

The *Chronus Pro* plugin adds additional features to the Chronus theme.
...
1. Install the Chronus Pro Plugin on Plugins -> Add New -> Upload Plugin by uploading the .ZIP plugin file.
...
Please see our [Chronus Theme Documentation](https://themezee.com/docs/chronus-documentation/ "Chronus Theme Documentation").
...
The Chronus Pro plugin includes the following third-party resources:
